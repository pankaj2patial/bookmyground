...
<%
 ...
 try
 {
	...
	String q = "insert into hockey_players_information values('"+name+"','"+nick_name+"','"+total_matches+"','"+club_team+"','"+squad_number+"','"+position+"','"+goals+"','"+age+"','"+height+"','"+weight+"','"+nty+"')";
...
<img src="ss.jpg" width = "500px" height = "450px" align = "left">
